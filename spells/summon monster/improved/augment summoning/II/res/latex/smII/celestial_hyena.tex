...
\def \allyroles{Sensor, Smiter, Tripper}
...
\skill{\stealthtallgrassskill}{\animalstealthranks}{\dexteritymod}{\classskillbonus}{\racialstealthbonus}{0}{0}{\sizestealthbonus}{0}
...
\textbf{Melee} bite \enhancedstat{+\bite} \hspace{1pt} (1d6+\enhancedstat{\strengthnhalf} \hspace{1pt} plus trip) \\
...
\textbf{Feats} \feats \\
\textbf{Skills} Acrobatics +\acrobaticsskill \hspace{1pt} (+\jumpskill \hspace{1pt} jumping), Climb \enhancedstat{+\climbskill}, Escape Artist +\escapeartistskill, \\ Intimidate \intimidateskill, Stealth +\stealthskill \hspace{1pt} (+\stealthtallgrassskill \hspace{1pt} in tall grass), Survival +\survivalskill, Swim \enhancedstat{+\swimskill} \\

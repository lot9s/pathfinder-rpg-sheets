...
\textbf{Poison (Ex)} Bite---injury; \textit{save} Fort DC \enhancedstat{16}; \textit{frequency} 1/round for 4 rounds; \\ \textit{effect} 1d2 Strength damage; \textit{cure} 1 save. The save DC includes a +2 racial bonus. \\

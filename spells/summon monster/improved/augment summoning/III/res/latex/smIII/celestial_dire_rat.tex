...
\textbf{Disease (Ex)} \textit{Filth fever}: Bite---injury; \textit{save} Fort DC \enhancedstat{13}; \textit{onset} 1d3 days; \\ \textit{frequency} 1/day; \textit{effect} 1d3 Dex damage and 1d3 Con damage; \\ \textit{cure} 2 consecutive saves. The save DC is Constitution-based. \\

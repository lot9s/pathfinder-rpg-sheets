...
\textbf{Melee}  bite +\bite \hspace{1pt} (1d2\enhancedstat{\strengthmod} \hspace{1pt} plus poison) \\
...
\textbf{Poison (Ex)} Injury; \textit{save} Fort DC \enhancedstat{11}; \textit{frequency} 1/round for 6 rounds; \\ \textit{effect} 1d2 Con damage; \textit{cure} 1 save \\

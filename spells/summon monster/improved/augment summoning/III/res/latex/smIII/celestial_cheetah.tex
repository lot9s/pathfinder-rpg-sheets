...
\def \allyroles{Sensor, Smiter, Striker, Tripper}
...
\def \racialtallgrassstealthbonus{4}
...
% --- Untrained Skills ---
\skill{\acrobaticsskill}{\animalacrobaticsranks}{\dexteritymod}{\classskillbonus}{0}{0}{0}{0}{0}
...
\skill{\jumpskill}{\animalacrobaticsranks}{\dexteritymod}{\classskillbonus}{\racialspeedjumpbonus}{0}{0}{0}{0}
\skill{\tallgrassstealthskill}{\animalstealthranks}{\dexteritymod}{\classskillbonus}{\racialtallgrassstealthbonus}{0}{0}{\sizestealthbonus}{0}



% --- Feats ---
\def \feats{Improved Initiative, Weapon Finesse, Weapon Proficiency (Natural)}
...
\textbf{Init} +\initiative; \textbf{Speed} \baselandspeed \hspace{1pt} ft., sprint \\ 
\textbf{Senses} \senses \\
...
\textbf{Melee} bite \enhancedstat{+\bite} \hspace{1pt} (1d6+\enhancedstat{\strengthmod} \hspace{1pt} plus trip), 2 claws \enhancedstat{+\claw} \hspace{1pt} (1d3+\enhancedstat{\strengthmod}) \\
...
\textbf{Feats} \feats \\
\textbf{Skills} Acrobatics +\acrobaticsskill \hspace{1pt} (+\jumpskill \hspace{1pt} jumping), Climb \enhancedstat{+\climbskill}, Escape Artist +\escapeartistskill, \\ Intimidate \intimidateskill, Stealth +\stealthskill \hspace{1pt} (+\tallgrassstealthskill \hspace{1pt} in tall grass), Survival +\survivalskill, Swim \enhancedstat{+\swimskill} \\
...
\textbf{Sprint (Ex)} Once per hour, a cheetah can move at 10 times its normal speed (500 feet) when it makes a charge. \\

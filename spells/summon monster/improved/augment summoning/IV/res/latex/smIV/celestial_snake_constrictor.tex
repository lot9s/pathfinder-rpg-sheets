% --- Ally Info ---
\def \name{Celestial Snake, Constrictor}
...
\combatmaneuverbonus{\allygrabcmb}{\baseattack}{\strengthmod}{\grabcmbbonus}
...
\skill{\perceptionskill}{\animalperceptionranks}{\wisdommod}{\classskillbonus}{\racialperceptionbonus}{\featperceptionbonus}{0}{0}{0}
...
\skill{\jumpskill}{\animalacrobaticsranks}{\dexteritymod}{\classskillbonus}{\racialacrobaticsbonus}{0}{0}{0}{-4}



% --- Feats ---
\def \feats{Skill Focus (Perception), Tougness, Weapon Proficiency (Natural)}
...
\textbf{Melee}  bite \enhancedstat{+\bite} \hspace{1pt} (1d4+\enhancedstat{\strengthnhalf} \hspace{1pt} plus grab) \\

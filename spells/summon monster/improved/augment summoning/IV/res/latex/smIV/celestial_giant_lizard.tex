...
\FPeval{\totalcmbgrapplebonus}{clip(\sizecmdmodifier + \grabcmbbonus)}
...
\skill{\undergrowthstealthskill}{\animalstealthranks}{\dexteritymod}{\classskillbonus}{\racialundergrowthstealthbonus}{0}{0}{0}{0}


% --- Feats ---
\def \feats{Great Fortitude, Skill Focus (Perception), Weapon Proficiency (Natural)}
...
\textbf{Melee} bite \enhancedstat{+\bite} \hspace{1pt} (1d8+\enhancedstat{\strengthnhalf} \hspace{1pt} plus grab and poison) \\
...
\textbf{Poison (Su)} Bite---injury; \textit{save} Fort DC \enhancedstat{16}; \textit{onset} 1 minute; \textit{frequency} 1/hour for 6 hours; \textit{effect} 1d2 Dexterity damage; \textit{cure} 1 save. The save DC is Constitution-based. \\

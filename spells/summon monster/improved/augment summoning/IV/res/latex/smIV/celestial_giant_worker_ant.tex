% --- Ally Info ---
\def \name{Celestial Ant, Giant (Worker)}
...
\skill{\climbskill}{}{\strengthmod}{0}{\racialclimbbonus}{0}{0}{0}{0}
...
\textbf{Melee} bite \enhancedstat{+\bite} \hspace{1pt} (1d6+\enhancedstat{\strengthmod}) \\

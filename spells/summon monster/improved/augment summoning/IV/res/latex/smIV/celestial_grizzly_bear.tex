...
\def \allyroles{Grappler, Sensor, Smiter, Striker, Tank}
...
\def \featsurvivalbonus{3}
\def \racialspeedjumpbonus{4}
\def \racialswimbonus{4}
...
\def \animalsurvivalranks{1}
\def \animalswimranks{2}
...
\skill{\survivalskill}{\animalsurvivalranks}{\wisdommod}{0}{0}{\featsurvivalbonus}{0}{0}{0}
\skill{\swimskill}{\animalswimranks}{\strengthmod}{\classskillbonus}{\racialswimbonus}{0}{0}{0}{0}
...
% --- Feats ---
\def \feats{Endurance, Run, Skill Focus (Survival), Weapon Finesse, \\ Weapon Proficiency (Natural)}
...
\textbf{Melee} bite \enhancedstat{+\bite} \hspace{1pt} (1d6+\enhancedstat{\strengthmod} \hspace{1pt} plus grab), 2 claws \enhancedstat{+\claw} \hspace{1pt} (1d6+\enhancedstat{\strengthmod}) \\

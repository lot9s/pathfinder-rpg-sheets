...
\textbf{Melee}  bite +\bite \hspace{1pt} (1d3+\enhancedstat{\strengthmod} \hspace{1pt} plus poison), tentacles +\tentacle \hspace{1pt} (grab) \\
...
\textbf{Poison (Ex)} Bite---injury; \textit{save} Fort DC \enhancedstat{15}; \textit{frequency} 1/round for 6 rounds; \\ \textit{effect} 1 Str damage; \textit{cure} 1 save

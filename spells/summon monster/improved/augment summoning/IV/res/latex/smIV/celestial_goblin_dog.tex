...
\FPeval{\hitpoints}{clip(\animalhitpoints + \bonushitpoints + \featbonushitpoints)}
...
\textbf{Melee}  bite \enhancedstat{+\bite} \hspace{1pt} (1d6+\enhancedstat{\strengthnhalf} \hspace{1pt} plus allergic reaction) \\

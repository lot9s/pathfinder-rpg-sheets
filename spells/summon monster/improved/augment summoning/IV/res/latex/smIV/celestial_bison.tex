% --- Ally Info ---
\def \name{Celestial Herd Animal, Bison}
...
\skill{\stealthskill}{0}{\dexteritymod}{0}{0}{0}{0}{0}{\sizestealthpenalty}
\skill{\survivalskill}{0}{\wisdommod}{0}{0}{0}{0}{0}{0}
\skill{\swimskill}{0}{\strengthmod}{0}{0}{0}{0}{0}{0}

\skill{\jumpskill}{0}{\dexteritymod}{0}{0}{0}{0}{\racialspeedjumpbonus}{0}



% --- Feats ---
\def \feats{Endurance, Improved Bull Rush, Power Attack, \\ Weapon Proficiency (Natural)}
...
\def \specialattacks{smite evil 1/day (+0 to hit, +\hitdice \hspace{1pt} to damage), stampede, \\ trample (2d6+\enhancedstat{\strengthnhalf}, DC \enhancedstat{22})}
...
\textbf{DR} 5/evil; \textbf{SR} 10; \textbf{Resist} acid 10, cold 10, electricity 10 \\
...
\textbf{Melee} gore \enhancedstat{+\gore} \hspace{1pt} (2d6+\enhancedstat{\strengthnhalf}) \\
...
\textbf{Stampede (Ex)} A stampede occurs if three or more creatures with stampede make a trample attack while remaining adjacent to each other. While stampeding, the creatures can trample foes of their size or smaller, and the trample's save DC increases by +2. \\

...
% --- Feats ---
\def \feats{Endurance, Great Fortitude, Skill Focus (Perception), \\ Weapon Proficiency (Natural)}
...
\def \specialattacks{powerful charge (gore, 4d6+\enhancedstat{\doublestrength}), \\ smite evil 1/day (+0 to attack, +\hitdice \hspace{1pt} to damage)}

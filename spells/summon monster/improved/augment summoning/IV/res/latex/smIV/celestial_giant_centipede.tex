...
\textbf{Poison (Ex)} Bite---injury; \textit{save} Fort DC \enhancedstat{15}; \textit{frequency} 1/round for 6 rounds; \textit{effect} 1d3 Dex damage; \textit{cure} 1 save. The save DC is Constitution-based and includes a +2 racial bonus.

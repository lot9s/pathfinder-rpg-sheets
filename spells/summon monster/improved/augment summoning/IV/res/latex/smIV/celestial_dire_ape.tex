...
\skill{\climbskill}{\animalclimbranks}{\strengthmod}{\classskillbonus}{\racialclimbbonus}{0}{0}{0}{0}
...
% --- Feats ---
\def \feats{Iron Will, Skill Focus (Perception), Weapon Proficiency (Natural)}
...
\def \specialattacks{rend (2 claws, 1d4+\enhancedstat{\strengthnhalf}), \\ smite evil 1/day (+0 to attack, +\hitdice \hspace{1pt} to damage)}
...
\textbf{Melee} bite \enhancedstat{+\bite} \hspace{1pt} (1d6+\enhancedstat{\strengthmod}), 2  claws \enhancedstat{+\claw} \hspace{1pt} (1d4+\enhancedstat{\strengthmod}) \\

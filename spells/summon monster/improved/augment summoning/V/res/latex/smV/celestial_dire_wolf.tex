...
\def \allyroles{Sensor, Smiter, Tank, Tripper}
...
% --- Feats ---
\def \feats{Run, Skill Focus (Perception), Weapon Focus (bite), \\ Weapon Proficiency (Natural)}
...
\textbf{Melee} bite \enhancedstat{+\bite} \hspace{1pt} (1d8+\enhancedstat{\strengthnhalf} \hspace{1pt} plus trip) \\

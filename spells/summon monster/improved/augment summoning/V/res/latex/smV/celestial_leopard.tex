...
\def \racialundergrowthstealthbonus{4}
...
\skill{\undergrowthstealthskill}{\animalstealthranks}{\dexteritymod}{\classskillbonus}{\racialundergrowthstealthbonus}{\featstealthbonus}{0}{\sizestealthbonus}{0}


% --- Feats ---
\def \feats{Skill Focus (Stealth), Weapon Finesse, Weapon Proficiency (Natural)}
...
\def \specialattacks{pounce, rake (2 claws \enhancedstat{+\claw} \hspace{1pt}, 1d3+\enhancedstat{\strengthmod}), \\ smite evil 1/day (+0 to attack, +\hitdice \hspace{1pt} to damage)}
...
\textbf{Melee} bite \enhancedstat{+\bite} \hspace{1pt} (1d6+\enhancedstat{\strengthmod} \hspace{1pt} plus grab), 2 claws \enhancedstat{+\claw} \hspace{1pt} (1d3+\enhancedstat{\strengthmod}) \\

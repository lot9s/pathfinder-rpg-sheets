% --- Ally Info ---
\def \name{Celestial Herd Animal, Auroch}
...
% --- Feats ---
\def \feats{Endurance, Skill Focus (Perception), Weapon Proficiency (Natural)}
...
\def \specialattacks{smite evil 1/day (+0 to hit, +\hitdice \hspace{1pt} to damage), stampede, \\ trample (2d6+\enhancedstat{\strengthnhalf}, DC \enhancedstat{19})}
...
\textbf{Melee} gore \enhancedstat{+\gore} \hspace{1pt} (1d8+\enhancedstat{\strengthnhalf}) \\

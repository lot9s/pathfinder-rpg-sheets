...
\def \allyroles{Grappler, Sensor, Smiter, Striker}
...
\FPeval{\totalcmbgrabbonus}{clip(\sizecmdmodifier + \grabcmbbonus)}
...
\combatmaneuverbonus{\allygrabcmb}{\baseattack}{\strengthmod}{\totalcmbgrabbonus}
...
\attack{\claw}{\baseattack}{\strengthmod}{0}{\sizeattackmodifier}{\featattackbonus}
...
\def \racialundergrowthstealthbonus{8}
\def \sizeflybonus{-2}
...
\skill{\stealthskill}{\animalstealthranks}{\dexteritymod}{\classskillbonus}{\racialstealthbonus}{0}{0}{\sizestealthbonus}{0}
\skill{\survivalskill}{0}{\wisdommod}{0}{0}{0}{0}{0}{0}
\skill{\swimskill}{0}{\strengthmod}{0}{0}{0}{0}{0}{0}


\skill{\undergrowthstealthskill}{\animalstealthranks}{\dexteritymod}{\classskillbonus}{\racialundergrowthstealthbonus}{0}{0}{\sizestealthbonus}{0}


% --- Feats ---
\def \feats{Improved Initiative, Run, Skill Focus (Perception), Weapon Focus (Claw), Weapon Proficiency (Natural)}
...
\def \specialattacks{pounce, rake (2 claws \enhancedstat{+\claw} \hspace{1pt}, 1d6+\enhancedstat{\strengthmod}), \\ smite evil 1/day (+0 to attack, +\hitdice \hspace{1pt} to damage)}
...
\textbf{Melee} bite \enhancedstat{+\bite} \hspace{1pt} (1d8+\enhancedstat{\strengthmod} \hspace{1pt} plus grab), 2 claws \enhancedstat{+\claw} \hspace{1pt} (1d6+\enhancedstat{\strengthmod}) \\
\textbf{Special Attacks} \specialattacks \\
\textbf{Base Attack} +\baseattack; \textbf{CMB} \enhancedstat{+\allycmb} \hspace{1pt} (\enhancedstat{+\allygrabcmb} \hspace{1pt} grapple); \textbf{CMD} \enhancedstat{\allycmd} \hspace{1pt} (\enhancedstat{\allytripcmd} \hspace{1pt} vs. trip) \\ 
\textbf{Feats} \feats \\

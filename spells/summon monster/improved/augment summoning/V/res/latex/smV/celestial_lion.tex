...
% --- Feats ---
\def \feats{Improved Initiative, Run, Skill Focus (Perception), \\ Weapon Proficiency (Natural)}
...
\def \specialattacks{pounce, rake (2 claws \enhancedstat{+\claw} \hspace{1pt}, 1d4+\enhancedstat{\strengthmod}), \\ smite evil 1/day (+0 to attack, +\hitdice \hspace{1pt} to damage)}
...
\textbf{Melee} bite \enhancedstat{+\bite} \hspace{1pt} (1d8+\enhancedstat{\strengthmod} \hspace{1pt} plus grab), 2 claws \enhancedstat{+\claw} \hspace{1pt} (1d4+\enhancedstat{\strengthmod}) \\

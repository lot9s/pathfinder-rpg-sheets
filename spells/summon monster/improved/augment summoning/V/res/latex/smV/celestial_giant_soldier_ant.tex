% --- Ally Info ---
\def \name{Celestial Ant, Giant (Soldier)}
...
\ability{\constitution}{\baseconstitution}{0}{0}{4}{0}{0}
\def \intelligence{---}
...
\textbf{Poison (Ex)} Sting---injury; \textit{save} Fort DC \enhancedstat{16}; \textit{frequency} 1/round for 4 rounds; \\ \textit{effect} 1d2 Str damage; \textit{cure} 1 save \\

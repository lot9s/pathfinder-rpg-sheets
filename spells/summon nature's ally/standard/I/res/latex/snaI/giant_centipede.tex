...
\textbf{Melee} bite +\bite \hspace{1pt} (1d6\strengthmod \hspace{1pt} plus poison) \\
...
\textbf{Poison (Ex)} Bite---injury; \emph{save} Fort DC 13; \emph{frequency} 1/round for 6 rounds; \emph{effect} 1d3 Dex damage; \emph{cure} 1 save. The save DC is Constitution-based and includes a +2 racial bonus.
